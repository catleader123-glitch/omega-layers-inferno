    ...
    constructor()
    {
        ...
        this.multiplierUpgrades = [
            new MetaDynamicLayerUpgrade("Increase the Resource Multiplier",
                level => Utils.createValueDilation(level.mul(Decimal.pow(1, Decimal.max(0, level.sub(1)))), 0.001).floor(),
                level => new Decimal(1),
            ...
            new MetaDynamicLayerUpgrade("Increase the Resource Multiplier",
                level => Utils.createValueDilation(level.mul(1).mul(Decimal.pow(1, Decimal.max(0, level.sub(1)))), 0.001).floor().add(10),
                level => new Decimal(1),
            ...
            new MetaDynamicLayerUpgrade("Increase the Resource Multiplier",
                level => Utils.createValueDilation(level.mul(1).mul(Decimal.pow(1, Decimal.max(0, level.sub(1)))), 0.001).floor().add(47),
                level => new Decimal(1),
            ...
            new MetaDynamicLayerUpgrade("Increase the Resource Multiplier",
                level => Utils.createValueDilation(level.mul(1).mul(Decimal.pow(1, Decimal.max(0, level.sub(1)))), 0.001).floor().add(143),
                level => new Decimal(1),
