...
class PrestigeLayer
{
    ...
    createUpgrades()
    {
        ...
        for(let i = 0; i < upgradeCount; i++)
        {
            ...
            let effectGenMulti = 0.001 + 0.0005 * rand.nextDouble(); //modded
            let effectPrestigeReward = 2 + rand.nextDouble() * 1.6; //modded
    ...
    {
        return 35 * Math.pow(1.1, Utils.clamp(layer - 5, 0, 25)); //layer thiong?
    }
